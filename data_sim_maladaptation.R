...
Pop1_plot <- ggplot() + 
  ...
  ylim(c(0,1)) +
  labs(title="Live MR - Population 1 - MR=0.2 (weak)") +
  theme_bw()
...
Pop2_plot <- ggplot() + 
  ...
  ylim(c(0,1)) +
  labs(title="Live MR - Population 2 - MR=0.8 (strong)") +
  theme_bw()  
