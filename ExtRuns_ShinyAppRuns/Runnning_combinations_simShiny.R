...
restoration_numb <- c(500, 1000, 2500)
...
for (i in 1:nrow(combinations_df)) {
  ...
  #rm(list = ls())
  ## Load in parameters
  source("ExtRuns_ShinyAppRuns/configurations_fromMultRun - Copy")
  
  MR_death_impact = combinations_df[i, "MR_iter"]
  intercept_togg = combinations_df[i, "restoration"]
  intercept_MR_mean = combinations_df[i, "restoration_MR"]
  intercept_indiv = combinations_df[i, "restoration_numb"]
  ...
  ## Save files after
  #Int
  write.csv(live_size_df, row.names = FALSE, file=paste0("ExtRuns_ShinyAppRuns/SIZE_int_MR_", MR_death_impact, "_restoration_", intercept_togg, "_numb_",intercept_indiv_original, "_level_", intercept_MR_mean ,".csv"))
  write.csv(MR_df, row.names = FALSE,file=paste0("ExtRuns_ShinyAppRuns/MR_int_MR_", MR_death_impact, "_restoration_", intercept_togg, "_numb_",intercept_indiv_original, "_level_", intercept_MR_mean ,".csv"))
